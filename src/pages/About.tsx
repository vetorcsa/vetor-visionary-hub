        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {aboutData.team.map((member, index) => (
              <div 
                key={member.id} 
                className="bg-black/40 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-vetor-green/10 hover:border-vetor-green/30 transition-all duration-300 animate-fade-in group"
